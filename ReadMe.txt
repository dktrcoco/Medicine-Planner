...
THEN the displayed calendar is populated with the times to take the medication, an aside listing side effects is displayed
WHEN I add an additional medication
THEN the displayed calendar is populated with the times to take the medication, 
...
WHEN I (the user) have taken my medication for the day
...
I want it to have a day-by-day calendar down to the time I should optimally take each medicine/vitamin with a built-in alert system to take the medication.
